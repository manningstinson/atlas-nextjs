  ...
  return (
    <form className="relative my-8" action={addQuestion}>
      ...
      <input type="text"name="title" className="w-full rounded-md border p-2 pr-28" placeholder="Ask a question..."
        required/>
      <button className="absolute right-2 top-0 flex h-10 w-24 items-center justify-center rounded-md border bg-secondary px-4 text-lg text-white focus:bg-secondary">
        Ask
      </button>
    </form>
  );
